...
#include "../include/mach/pssBspApisInline.h" 
...
#if defined(RD_98DX3121) || defined(DB_98DX4122) || defined(DB_X500PROTOTYPE)/*XCat Boards*/

#define MV_INCLUDE_SAGE

/* PEX */
#if defined(DB_X500PROTOTYPE)
/*td for x500*/
#define PEX0_MEM_BASE 0xB0000000
#define PEX0_MEM_SIZE _256M
#define PEX0_IO_BASE (0xC0000000)
#define PEX0_IO_SIZE _2M
#else
...
/*pci defines */
#define PCI0_IO_SIZE    _8M
#define PCI1_IO_SIZE    _8M
#define PCI2_IO_SIZE    _8M
#define PCI3_IO_SIZE    _8M
...
#define PCI0_IO_BASE    (PCI5_MEM0_BASE + PCI5_MEM0_SIZE)
