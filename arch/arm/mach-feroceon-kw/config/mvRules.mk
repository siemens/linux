...
ifeq ($(CONFIG_X500PROTOTYPE),y)
EXTRA_CFLAGS    += -DDB_X500PROTOTYPE
endif
...
ifeq ($(CONFIG_MV_PRESTERA_USE_MII_DRIVER),y)
EXTRA_CFLAGS    += -DMV_PRESTERA_USE_MII_DRIVER
endif
