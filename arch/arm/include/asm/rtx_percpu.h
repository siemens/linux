/*
 * arch/arm/include/asm/rtx_percpu.h
 *
 ...
 *
 */
#ifndef _ARM_RTX_PERCPU_H_
#define _ARM_RTX_PERCPU_H_
...
static inline void __rtx_restore_stalled_bit(unsigned long stalled)
{
	if (stalled)	__rtx_set_stalled_bit();
	else	__rtx_reset_stalled_bit();
}

#endif

#endif /* _ARM_RTX_PERCPU_H_ */
