/*
 * arch/arm/include/asm/rtx_base.h
 *
 ...
 *
 */
#ifndef _ARM_RTX_BASE_H_
#define _ARM_RTX_BASE_H_
#include <asm/bitsperlong.h>

struct irq_desc;

#ifdef CONFIG_ARCH_FEROCEON_KW
#include "../../mach-feroceon-kw/include/mach/irqs.h"
#endif
...
#include "../../plat-mxc/include/mach/irqs.h"
#include "../../plat-mxc/include/mach/hardware.h"
#endif
...
#define LX_PENDING_SYNC			1	// pending LX interrupts or VIRQs are currently in work

#define LX_IRQS_STALLED_MASK	(1L << LX_IRQS_STALLED)
#define LX_PENDING_SYNC_MASK	(1L << LX_PENDING_SYNC)
