/*
 * arch/powerpc/include/asm/rtx_base.h
 *
 ...
 *
 */
#ifndef _POWERPC_RTX_BASE_H_
#define _POWERPC_RTX_BASE_H_
...
// rt one shot timer: use own max value
// (see kernel/rtx_adapt.c)
#define RTX_MAX_DELTA_NS		ULONG_MAX
