 ...
 *   adaption to powerpc by manfred.neugebauer@siemens.com
 */

#ifndef _POWERPC_INCLUDE_ASM_RTX_ARITH_32_H
#define _POWERPC_INCLUDE_ASM_RTX_ARITH_32_H
...
__rtx_powerpc_ulldiv (const unsigned long long ull,
                     const unsigned d,
...
#define rtx_ulldiv(ull,d,rp) __rtx_powerpc_ulldiv((ull),(d),(rp))

#endif

#include <linux/rtx_arith.h>

#endif /* _POWERPC_INCLUDE_ASM_RTX_ARITH_32_H */
