...
int main(void)
{
	...
	DEFINE(TS_rt_state, offsetof(struct task_struct, rt_state));
	DEFINE(TS_rt_state2, offsetof(struct task_struct, rt_state2));
	DEFINE(TS_rt_state3, offsetof(struct task_struct, rt_state3));
	DEFINE(TS_rt_syscall_id, offsetof(struct task_struct, rt_syscall_id));
#endif
