 ...
 *
 *  The Audis extension is adapted from the adeos-ipipe patch
 *  by <wolfgang.hartmann@siemens.com>
 */
	   ...
	   unsigned long address)
{
	...
	if (fixup_exception(regs)) {
		if ((current->rt_state & RTLX_TASK) && (current->rt_state3 & RT_TASK_FAULT_DETECTED)) {
