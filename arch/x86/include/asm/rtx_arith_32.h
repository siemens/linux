...
#ifndef _RTX_ASM_X86_ARITH_32_H
#define _RTX_ASM_X86_ARITH_32_H
#define _RTX_ASM_X86_ARITH_32_H
...
__rtx_uldivrem(const unsigned long long ull, const unsigned long d)
{
...
static inline unsigned long __rtx_i386_uldivrem(unsigned long long ull,
                                                  const unsigned d,
                                                  unsigned long *const rp)
{
    unsigned long q, r;
    ull = __rtx_uldivrem(ull, d);
    __asm__ ( "": "=d"(r), "=a"(q) : "A"(ull));
    if(rp)
        *rp = r;
    return q;
}
#define rtx_uldivrem(ull, d, rp) __rtx_i386_uldivrem((ull),(d),(rp))

/* Division of an unsigned 96 bits ((h << 32) + l) by an unsigned 32 bits.
   Building block for ulldiv. */
static inline unsigned long long __rtx_div96by32 (const unsigned long long h,
                                                    const unsigned long l,
                                                    const unsigned long d,
                                                    unsigned long *const rp)
{
    u_long rh;
    const u_long qh = rtx_uldivrem(h, d, &rh);
    const unsigned long long t = __rtx_u64fromu32(rh, l);
    const u_long ql = rtx_uldivrem(t, d, rp);

    return __rtx_u64fromu32(qh, ql);
}

/* Slow long long division. Uses rtx_uldivrem, hence has the same property:
   the compiler removes redundant calls. */
static inline unsigned long long
__rtx_i386_ulldiv (const unsigned long long ull,
                     const unsigned d,
                     unsigned long *const rp)
{
    unsigned long h, l;
...
#define rtx_ulldiv(ull,d,rp) __rtx_i386_ulldiv((ull),(d),(rp))

/* Fast scaled-math-based replacement for long long multiply-divide */
#define rtx_llmulshft(ll, m, s)					\
({									\
	long long __ret;						\
	unsigned __lo, __hi;						\
									\
...
__rtx_x86_nodiv_ullimd(const unsigned long long op,
...
#define rtx_nodiv_ullimd(op, frac, integ) \
	__rtx_x86_nodiv_ullimd((op), (frac), (integ))

#include <linux/rtx_arith.h>

#endif /* _RTX_ASM_X86_ARITH_32_H */
