...
/* assumption: using the __switch_mm call: hw interrupts must be blocked! */
                             ...
                             struct task_struct *tsk)
{
	...
	/* globally blocked: local_irq_save_hw(flags); */
	mtflags = dvpe();
#else /* Not SMTC */
	/* globally blocked: local_irq_save_hw(flags); */
#endif /* CONFIG_MIPS_MT_SMTC */
	...
	/* globally blocked: local_irq_restore_hw(flags); */
}
...
#define rt_switch_mm(a, b, c)		__switch_mm(a, b, c)

#else /* not CONFIG_RTX_DOMAIN */
...
activate_mm(struct mm_struct *prev, struct mm_struct *next)
{
	...
	/*
	 * kernel/fork.c: with CONFIG_RTX_DOMAIN hard interrupt locking is done
	 * there. So we don't need it to do here.
	 */
#ifndef CONFIG_RTX_DOMAIN
	local_irq_save(flags);
#endif
