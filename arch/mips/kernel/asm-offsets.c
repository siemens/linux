...
void output_task_defines(void)
{
	...
	OFFSET(TS_rt_state, task_struct, rt_state);
	OFFSET(TS_rt_state2, task_struct, rt_state2);
	OFFSET(TS_rt_state3, task_struct, rt_state3);
	OFFSET(TS_rt_syscall_id, task_struct, rt_syscall_id);
#endif
	BLANK();
}
