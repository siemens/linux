...
struct scw_eth_stats {
    u32 drop_events;	/* drop events */
    u32 rx_bytes;		/* bytes received */
    u32 rx_all_pkts;	/* total pkts. received */
    u32 rx_bcast_pkts;	/* broadcast pkts received */
    u32 rx_multi_pkts;	/* multicast pkts received */
    u32 crc_align_err;	/* crc and align errors in correctly sized packets */
    u32 undersize_pkts;	/* <64 bytes pkts with no FCS problems */
    u32 oversize_pkts;	/* >1518 bytes pkts with no FCS errors */
    u32 fragments;		/* <64 byte packets with FCS problems */
    u32 jabbers;		/* >1518 byte pkts with FCS errors */
    u32 collisions;		/* collisions detected */
    u32 pkts_64;		/* 64 byte packets received */
    u32 pkts_65_127;	/* 65 <= pkt. size <= 127 */
    u32 pkts_128_255;	/* 128 <= pkt. size <= 255 */
    u32 pkts_256_511;	/* 256 <= pkt. size <= 511 */
    u32 pkts_512_1023;	/* 512 <= pkt. size <= 1023 */
    u32 pkts_1024_1518;	/* 1024 <= pkt. size <= 1518 */
};
...
#endif
#ifdef CONFIG_SIMATIC_NET_SCALANCE_W
	struct	scw_eth_stats		scw_stats;
	int				safe;
#endif
};
