/*
 * linux/drivers/aud/application_driver/pbus_plus.c
 *
 * Copyright (C) 2008-2012 manfred.neugebauer@siemens.com
 *                         and others
 *
 ...
 *
 * Driver for the pbus_plus bus interface for Siemens boards
 *
...
#define PRIVATE_DRIVER_NAME "pbus_plus"

#ifdef MODULE
MODULE_AUTHOR("Manfred Neugebauer");
MODULE_DESCRIPTION( "Linux driver for pbus_plus device" );
MODULE_LICENSE("GPL");
#endif
...
// event definitions
#define PBP_INT_CSIR_OFFSET			0
#define PBP_INT_CSIR_S1_OFFSET			PBP_INT_CSIR_OFFSET		// Offset of all interrupt identifiers that refer to config state interrupt register S1
#define PBP_INT_CSIR_S2_OFFSET			(PBP_INT_CSIR_S1_OFFSET + 32)	// Offset of all interrupt identifiers that refer to config state interrupt register S2
 
// event identifier offset  
#define PBP_ADDITIONAL_IDENTIFIER_OFFSET	(PBP_INT_CSIR_S2_OFFSET + 32)	// Offset of non-interrupt-identifiers handled as event  
...
#define PBP_INT_CSIR_S_INT_S2_REG_MOREFOLLOW		(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_S2_REG_MOREFOLLOW)  ///< Identifier of interrupt register INTREQ_S2 happens
#define PBP_INT_CSIR_S_INT_SEA_DOUT_TRIG_2		(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_SEA_DOUT_TRIG_2)  ///< Identifier of data trigger 2 interrupt
#define PBP_INT_CSIR_S_INT_SEA_DOUT_TRIG_1		(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_SEA_DOUT_TRIG_1)  ///< Identifier of data trigger 1 interrupt
#define PBP_INT_CSIR_S_INT_CLK_5			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_CLK_5)  ///< Identifier of data clock interrupt from T_DC_5
#define PBP_INT_CSIR_S_INT_CLK_4			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_CLK_4)  ///< Identifier of data clock interrupt from T_DC_4
#define PBP_INT_CSIR_S_INT_CLK_3			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_CLK_3)  ///< Identifier of data clock interrupt from T_DC_3
#define PBP_INT_CSIR_S_INT_CLK_2			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_CLK_2)  ///< Identifier of data clock interrupt from T_DC_2
#define PBP_INT_CSIR_S_INT_CLK_1			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_CLK_1)  ///< Identifier of data clock interrupt from T_DC_1
#define PBP_INT_CSIR_S_INT_CLK_0			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_CLK_0)  ///< Identifier of data clock interrupt from T_DC_0
#define PBP_INT_CSIR_S_INT_DIFF_CYCLE_TIMER		(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_DIFF_CYCLE_TIMER)  ///< Identifier of new data in register Diff_Cycle_Timer
#define PBP_INT_CSIR_S_INT_NEW_CYCLE			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_NEW_CYCLE) ///< Identifier of new cycle starts interrupt
#define PBP_INT_CSIR_S_INT_S_DATACLOCK_SYNC		(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_S_DATACLOCK_SYNC)
#define PBP_INT_CSIR_S_INT_S_PHASE_VIOLATION		(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_S_PHASE_VIOLATION) 
#define PBP_INT_CSIR_S_INT_JITTER_RANGE_VIOLATION	(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_JITTER_RANGE_VIOLATION) ///< Identifier of interrupt when jitter is to big
#define PBP_INT_CSIR_S_INT_CLOCK_FRAME_REC		(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_CLOCK_FRAME_REC) ///< Identifier of clock frame received interrupt
#define PBP_INT_CSIR_S_INT_TIME_FRAME_REC		(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_INT_TIME_FRAME_REC) ///< Identifier of time frame received interrupt
#define PBP_INT_CSIR_S_AZK_REC_1_INT			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_AZK_REC_1_INT)
#define PBP_INT_CSIR_S_AZK_REC_0_INT			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_AZK_REC_0_INT)
#define PBP_INT_CSIR_S_AZK_REC_CMD_INT			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_AZK_REC_CMD_INT)
#define PBP_INT_CSIR_S_AZK_SND_INT			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_AZK_SND_INT)
#define PBP_INT_CSIR_S_AZK_SND_CMD_INT			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_AZK_SND_CMD_INT)
#define PBP_INT_CSIR_S_ALARMCREATETYPEINT		(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_ALARMCREATETYPEINT) ///< Identifier of AlarmTypeFlag reset because of AlarmQuit
#define PBP_INT_CSIR_S_LALARMCREATEBUSYINT		(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_LALARMCREATEBUSYINT) ///< Identifier of BufferBusy reset because of AlarmInfoRdLow
#define PBP_INT_CSIR_S_HALARMCREATEBUSYINT		(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_HALARMCREATEBUSYINT) ///< Identifier of BufferBusy reset because of AlarmInfoRdHigh
#define PBP_INT_CSIR_S_NEWSUBMODODIS			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_NEWSUBMODODIS) ///< Identifier of submodule granular ODIS telegram received
#define PBP_INT_CSIR_S_NEWGLOBODIS			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_NEWGLOBODIS) ///< Identifier of global ODIS telegram received
#define PBP_INT_CSIR_S_SEA_SYSEDATA2INT			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_SEA_SYSEDATA2INT) ///< Identifier of interrupt when system input range 2 has been read
#define PBP_INT_CSIR_S_SEA_SYSEDATA1INT			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_SEA_SYSEDATA1INT) ///< Identifier of interrupt when system input range 1 has been read
#define PBP_INT_CSIR_S_SEA_EDATAINT			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_SEA_EDATAINT) ///< Identifier of interrupt when system input range has been read
#define PBP_INT_CSIR_S_SEA_SYSADATA2INT			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_SEA_SYSADATA2INT) ///< Indicate that the method enableBusStartup has been called.
#define PBP_INT_CSIR_S_SEA_SYSADATA1INT			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_SEA_SYSADATA1INT) ///< Identifier of interrupt when system output range 1 has been written
#define PBP_INT_CSIR_S_SEA_ADATAINT			(PBP_INT_CSIR_S1_OFFSET + PBP_IRQ_S1_SEA_ADATAINT) ///< Identifier of interrupt when system output range has been written
#define PBP_INT_CSIR_S_KOBUF_DMA_XFR_END		(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_KOBUF_DMA_XFR_END) ///< Identifier of transfer end interrupt from DMA
#define PBP_INT_CSIR_S_APP_IR_READY_INT			(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_APP_IR_READY_INT)
#define PBP_INT_CSIR_S_INT_MBF_INT_PBUSP_RAM		(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_INT_MBF_INT_PBUSP_RAM)
#define PBP_INT_CSIR_S_INT_OBF_INT_PBUSP_RAM		(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_INT_OBF_INT_PBUSP_RAM)
#define PBP_INT_CSIR_S_INT_TIME_SYNC_ERROR		(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_INT_TIME_SYNC_ERROR) ///< Identifier of interrupt when no correct time frame received while Time_Sync_Time
#define PBP_INT_CSIR_S_INT_TIME_LENGTH_ERR		(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_INT_TIME_LENGTH_ERR) ///< Identifier of interrupt when received time frame telegram couldn´t be stored in PBus+ RAM because of insufficient RAM
#define PBP_INT_CSIR_S_INT_CLOCK_SYNC_ERROR		(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_INT_CLOCK_SYNC_ERROR) ///< Identifier of interrupt when no correct clock frame received while Clock_Sync_Time
#define PBP_INT_CSIR_S_INT_CLOCK_LENGTH_ERR		(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_INT_CLOCK_LENGTH_ERR) ///< Identifier of interrupt when received clock frame telegram couldn´t be stored in PBus+ RAM because of insufficient RAM
#define PBP_INT_CSIR_S_BUS_ACT_STATE_INT		(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_BUS_ACT_STATE_INT) ///< Identifier of interrupt when activity on bus
#define PBP_INT_CSIR_S_PORT_STAT_CHANGE_INT		(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_PORT_STAT_CHANGE_INT) ///< Identifier of interrupt when changing port state
#define PBP_INT_CSIR_S_NEWMODADDR			(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_NEWMODADDR) ///< Identifier of interrupt when module address changed
#define PBP_INT_CSIR_S_INT_SEA_DOUT_TRIG_4		(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_INT_SEA_DOUT_TRIG_4) ///< Identifier of data trigger 4 interrupt
#define PBP_INT_CSIR_S_INT_SEA_DOUT_TRIG_3		(PBP_INT_CSIR_S2_OFFSET + PBP_IRQ_S2_INT_SEA_DOUT_TRIG_3) ///< Identifier of data trigger 3 interrupt

#define PBP_LOW_ALARM_ACKNOWLEDGEMENT_RECEIVED	(PBP_ADDITIONAL_IDENTIFIER_OFFSET + 0)

#define MAX_NR_OF_SOFT_INTR			(PBP_LOW_ALARM_ACKNOWLEDGEMENT_RECEIVED - PBP_ADDITIONAL_IDENTIFIER_OFFSET + 1)
...
#define TSEC_ADDRESS_BASE		(CONFIG_SYS_IMMR + CONFIG_SYS_TSEC1_OFFSET)
...
#ifdef __mips__
#define WATCHDOG_ADDRESS_BASE		0x1F700000
#endif // __mips__


#define NO_OF_EVENTS		(MAX_NR_OF_CSIR_INTR + MAX_NR_OF_SOFT_INTR + 1)
...
static uint8_t usr_irq_prio[MAX_NR_OF_CSIR_INTR + 1];
...
#define INDEX_BAR_MAX		(INDEX_BAR5 + 1)
...
#define PBP_IRQ_ENABLE(a)	enableCSIRExtInterrupt(a)
#define PBP_IRQ_DISABLE(a)	disableCSIRExtInterrupt(a)
		  ...
		  unsigned int cmd, unsigned long arg)
{
	...
	if (verbose)
		printkGen(NULL, "%s: pbus_plus_ioctl cmd=%#x arg=%#lx\n",
	...
	case PBP_INT_ENABLE:
		...
		intrNr = myArgs[0];
		if ((intrNr < PBP_INT_CSIR_S1_OFFSET)
				|| (intrNr >= (PBP_INT_CSIR_S2_OFFSET + MAX_NR_OF_S2_INTR))) {
			printkGen(NULL, "   unvalid intrNr:%d\n", intrNr);
			ret = -EINVAL;
			break;
		}
		intrNr -= PBP_INT_CSIR_S1_OFFSET;
		PBP_IRQ_ENABLE(intrNr);
        	break;
	...
	case PBP_CONFIG_PRIO:
		...
		if ((myArgs[1] != PBP_CSIR_INTERRUPT_PRIORITY_HIGH)
			...
			printkGen(NULL, "   unvalid prio value:%d\n", myArgs[1]);
			ret = -EINVAL;
			break;
		}
	...
	case AuD_EVENT_CREATE:
		...
		if (!myPtrForTargetPci) {
			...
			return -ENOMEM;
                ...
                memset(myPtrForTargetPci, 0, myTargetPciLen);
		...
		resetPciHostMapping(myPciDevInfo.pciAddress);
...
static int pbus_plus_read(struct file *filp, char *pC, size_t len,
	loff_t *f_pos)
{
	printkGen(NULL, "%s: pbus_plus_read buf=%p len=%#x\n", PRIVATE_DRIVER_NAME,
		pC, len);
...
static int pbus_plus_write(struct file *filp, const char *src, size_t len,
	loff_t *ppos)
{
	printkGen(NULL, "%s: pbus_plus_write buf=%p len=%#x\n", PRIVATE_DRIVER_NAME,
		src, len);
...
static void pbus_plus_mmap_kernel_vma_close(struct vm_area_struct *vma)
{
	...
	for (offsetInVma = 0; offsetInVma < vsize; offsetInVma += 0x1000) {
		put_page(virt_to_page((void *)(CAC_ADDR(kernelAddr + offsetInVma))));
	}
}
                                    ...
                                    struct vm_fault *vmf)
{
	...
	kernelptr = ((char *)ms_asic_pci_slot[deviceSlot].kernelAddr + offsetInVma + offsetInMemory);
        // strange stuff: for the kernel we need this address uncached (coherent)
        //                for the user mapping we need this address as original (cached)
        //                the vma protection flags are used to get an uncached access again
        kernelptr = CAC_ADDR(kernelptr);
...
static struct vm_operations_struct pbus_plus_mmap_kernel_vm_ops = {
...
static int pbus_plus_mmap_kernel_ram(struct vm_area_struct *vma)
{
	...
	vma->vm_page_prot = pgprot_noncached(vma->vm_page_prot);
        ...
        vma->vm_ops = &pbus_plus_mmap_kernel_vm_ops;
...
static int pbus_plus_mmap(struct file *Filep, struct vm_area_struct *vma)
{
	...
	else if (off >= OFFSET_BAR4) {
        	off -= OFFSET_BAR4;
		bar = INDEX_BAR4;
#ifdef __powerpc__
		// we also map the tsec led memory range
		// into the address range of the user
		bar_size = PAGE_SIZE;
		PhysAddr = TSEC_ADDRESS_BASE;
		bereich_name = "TSEC";
#elif __mips__
		// we also map the watchdog memory range
		// into the address range of the user
		bar_size = PAGE_SIZE;
		PhysAddr = WATCHDOG_ADDRESS_BASE;
		bereich_name = "WATCHDOG";
#else
		vma_ref[bar] = 0;
		return -EINVAL;
#endif
...
static int pbus_plus_release(struct inode *inode, struct file *filp)
{
	...
	for (ii = 0; ii < MAX_DEVICE_SLOT_NR; ii++) {
        	if (ms_asic_pci_slot[ii].busy) {
				...
				resetPciHostMapping(ms_asic_pci_slot[ii].actPciAddr);
...
static irqreturn_t pbus_plus_isr_high(int irq, void *dev_id)
{
	...
	if (eventActiveFlag[evtId1]) {
		...
		if (ppdrv_ev_arr[evtId1].ev_id == PBP_INT_CSIR_S_ALARMCREATETYPEINT) {
			...
			PBP_IRQ_ENABLE(PBP_IRQ_S1_ALARMCREATETYPEINT);
		}
	}
...
#endif
		printkGen(NULL, "%s: unvalid pbus_plus_isr_low irq=%d dev=%p\n",PRIVATE_DRIVER_NAME,
			irq, dev_id);
		goto irqLowEnd;
	}
...
static int pbus_plus_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
{
	...
	*configPtr = *configPtr | 0x0600;
...
#elif __mips__
        irq1 = IRQ_PBUS_PLUS_INTH;
        irq2 = IRQ_PBUS_PLUS_INTL;
#else
        irq1 = irq2 = pci_mem.usedIrq;
#endif
	...
	pbp_virtual_base_addr[INDEX_BAR3] = 0;
#ifdef __powerpc__
	// we also map the ethernet port led register memory range
	// into the address range of this driver
	pbp_virtual_base_addr[INDEX_BAR4] = ioremap(TSEC_ADDRESS_BASE, PAGE_SIZE);
#elif __mips__
	// we also map the watch dog memory range
	// into the address range of this driver
	pbp_virtual_base_addr[INDEX_BAR4] = ioremap(WATCHDOG_ADDRESS_BASE, PAGE_SIZE);
#else
	pbp_virtual_base_addr[INDEX_BAR4] = 0;
#endif
